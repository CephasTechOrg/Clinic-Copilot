...
- [ ] Add `.gitignore` (Python + venv + db + .env)
- [ ] Add `.env.example` (safe template without real keys)
...
- [ ] Seed demo data button (1-click demo mode)

✅ Overall: Core product + backend scaffold + Gemini AI + UI prompts are **covered**.